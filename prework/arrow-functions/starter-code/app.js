...
let arrowSumProduct = (a, b) => {
  let sum = a + b;
  let product = a * b;
  return [sum, product];
};
console.log(arrowSumProduct(3,9));
...
let arrowMessage = name => `Hello, ${name}!`;
...
let arrowJoe = () => new Student('Joe', 'Schmoe', 100);

// TODO: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this code to break!
console.log(joe);
console.log(arrowJoe());
...
// undefined, it's the value of an undefined "scope"
// 2. What is "this" when joe.scopeArrow() is invoked?
// the object scope
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions don't hold the 'this' value
